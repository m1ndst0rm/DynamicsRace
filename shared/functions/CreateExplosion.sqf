...
DYN_RACE_CreateExplosion = 
{
	...
	_ammo = ["Sh_120_HE","HelicopterExploBig","HelicopterExploBig","Sh_120_HE","HelicopterExploBig"];
	...
	
	{
		...
		if !(_explosion_marker_name in DYN_RACE_EXPLOSIONS) then
		{
			...
			_explosions_to_create set [count DYN_RACE_EXPLOSIONS, _explosion_marker_name];
		};
	} forEach _markers; 
